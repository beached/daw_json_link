...
namespace daw::json {
	DAW_JSON_INLINE_NS namespace DAW_JSON_VER {
		 ...
		 */
		enum class JsonNullable : json_details::json_options_t { MustExist, Nullable, NullVisible };
		...
		namespace json_details {
			...
			template<JsonNullable nullable>
			inline constexpr bool is_nullable_json_value_v = is_nullable_json_value<nullable>::value;
		} // namespace json_details

		inline namespace details {
			template<JsonParseTypes ParseType, JsonNullable Nullable>
			inline constexpr JsonParseTypes get_parse_type_v =
			  json_details::is_nullable_json_value_v<Nullable> ? JsonParseTypes::Null : ParseType;
		} // namespace details
