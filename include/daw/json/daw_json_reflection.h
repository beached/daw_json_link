...
namespace daw::json::inline DAW_JSON_VER::inline experimental::refl_details {
	...
	consteval bool has_reflected_submembers( ) {
		static constexpr auto members = [:as_stdarray( pub_nsdm_of( ^^T ) ):];
...
namespace daw::json::inline DAW_JSON_VER::inline experimental {
...
namespace daw::json::inline DAW_JSON_VER {
	...
	concept ReflectionEnabled =
	  enable_reflection_for<T> or refl_details::has_annotation<reflect_t, T>( ) or
