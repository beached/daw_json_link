...
namespace daw::json {
	DAW_JSON_INLINE_NS namespace DAW_JSON_VER {
		...
		struct json_member_list {
			...
			static_assert( std::conjunction_v<json_details::is_a_json_type<JsonMembers>...>,
			               "Only JSON Link mapping types can appear in a "
			               "json_member_list(e.g. json_number, json_string...)" );

			static_assert( not std::disjunction_v<json_details::is_no_name<JsonMembers>...>,
			...
			serialize( OutputIterator it, Tuple<Ts...> const &args, Value const &v ) {
				...
				static_assert( ( (not std::is_rvalue_reference_v<Ts>)and... ),
			...
			using result_type =
			  json_details::json_class_parse_result_t<Constructor,
			                                          json_details::without_name<JsonMembers>...>;
			/**
			 *
			...
			[[maybe_unused,
			  nodiscard]] DAW_ATTRIB_FLATTEN static inline constexpr json_details::json_result<JsonClass>
			parse_to_class( ParseState &parse_state, template_param<JsonClass> ) {
				...
				static_assert( json_details::has_json_data_contract_trait_v<typename JsonClass::base_type>,
				               "Unexpected type" );
				using json_class_t =
				  typename std::conditional_t<json_details::is_no_name_v<JsonClass>,
				                              traits::identity<JsonClass>,
		...
		struct json_class_map {
			...
			static_assert( json_details::is_no_name_v<json_member>,
			...
			serialize( OutputIterator it, Member const &m, Value const & ) {
				return json_details::member_to_string( template_arg<json_member>, it, m );
			}
			...
			template<typename JsonClass, typename ParseState>
			[[maybe_unused,
			  nodiscard]] DAW_ATTRIB_FLATTEN static constexpr json_details::json_result<JsonClass>
			parse_to_class( ParseState &parse_state, template_param<JsonClass> ) {
				static_assert( json_details::is_a_json_type_v<JsonClass> );
				static_assert( json_details::has_json_data_contract_trait_v<typename JsonClass::base_type>,
				               "Unexpected type" );
				...
				return json_details::construct_value( template_args<JsonClass, Constructor>,
				                                      parse_state,
		...
		struct json_details::is_json_class_map<json_class_map<JsonType>> : std::true_type {};
		...
		template<std::size_t Index, typename JsonMember>
		using ordered_json_member [[deprecated( "Use json_tuple_member, removal in v4" )]] =
		  json_tuple_member<Index, JsonMember>;

		namespace json_details {
			template<typename JsonMember>
			using json_tuple_member_wrapper = std::conditional_t<is_an_ordered_member_v<JsonMember>,
			                                                     JsonMember,
		...
		struct json_tuple_member_list {
			...
			static_assert( std::conjunction_v<json_details::is_no_name<JsonMembers>...>,
			...
			[[maybe_unused, nodiscard]] static inline constexpr OutputIterator
			serialize( OutputIterator it, Tuple<Ts...> const &args, Value const &v ) {
				static_assert( sizeof...( Ts ) == sizeof...( JsonMembers ), "Argument count is incorrect" );
				static_assert( ( (not std::is_rvalue_reference_v<Ts>)and... ),
				               "The Tuple contains rvalue references.  The values "
				               "passed are now dangling.  daw::forward_nonrvalue_as_tuple in "
				               "<daw/daw_tuple_forward.h> can forward only non-rvalue refs and "
				               "store the temporaries" );
				static_assert( std::conjunction<json_details::is_a_json_type<
			...
			using result_type = json_details::json_class_parse_result_t<
			  Constructor,
			  json_details::ordered_member_subtype_t<json_details::json_deduced_type<JsonMembers>>...>;
			/**
			 *
			 * Parse JSON data and construct a C++ class.  This is used by parse_value
			 * to get back into a mode with a JsonMembers...
			 ...
			 */
			template<typename JsonClass, typename ParseState>
			[[maybe_unused, nodiscard]] static inline constexpr json_details::json_result<JsonClass>
			parse_to_class( ParseState &parse_state, template_param<JsonClass> ) {
				...
				return json_details::parse_json_tuple_class(
				  template_args<JsonClass, json_details::json_tuple_member_wrapper<JsonMembers>...>,
				  parse_state );
			}
		};

		template<typename... JsonMembers>
		using json_ordered_member_list [[deprecated( "Use json_tuple_member_list, removal in v4" )]] =
		...
		struct json_submember_tagged_variant {
			...
			serialize( OutputIterator it, Value const &v ) {
				...
				return daw::visit_nt( v, [&]( auto const &alternative ) {
					...
					static_assert( std::disjunction_v<std::is_same<Alternative, JsonClasses>...>,
					...
					return json_details::member_to_string( template_arg<json_base::json_class<Alternative>>,
					                                       it,
					                                       alternative );
				} );
			}
			...
			using result_type = json_details::json_class_parse_result_t<
			  Constructor,
			  json_details::json_deduced_type<daw::traits::first_type<JsonClasses...>>>;
			/**
			 *
			 * Parse JSON data and construct a C++ class.  This is used by parse_value
			 * to get back into a mode with a JsonMembers...
			 ...
			 */
			template<typename JsonClass, typename ParseState>
			[[maybe_unused, nodiscard]] DAW_ATTRIB_FLATTEN static inline constexpr json_details::
			  ...
			  parse_to_class( ParseState &parse_state, template_param<JsonClass> ) {
				...
				std::size_t const idx = [parse_state]( ) mutable {
					return Switcher{ }(
					  std::get<0>( json_details::parse_value<json_base::json_class<tag_class_t>>(
					                 parse_state,
				...
				return json_details::
				  parse_nth_class<0, JsonClass, false, json_base::json_class<JsonClasses>...>(
				    idx,
				    parse_state );
			}
		};
		...
		namespace json_base {
			template<typename T, json_details::json_options_t Options, typename Constructor>
			struct json_number {
				using i_am_a_json_type = void;
				...
				static_assert( traits::not_same<void, base_type>::value, "Failed to detect base type" );

				static_assert( daw::is_arithmetic<base_type>::value,
				               "json_number requires an arithmetic type" );

				using parse_to_t = typename json_details::
				  construction_result<nullable != JsonNullable::MustExist, Constructor, base_type>::type;

				static_assert(
				  std::disjunction_v<not_trait<json_details::is_nullable_json_value<nullable>>,
				...
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Number;
		...
		using json_number = json_named_member<Name, json_base::json_number<T, Options, Constructor>>;
		 ...
		 */
		template<JSONNAMETYPE Name,
		         typename T = std::optional<double>,
		         json_details::json_options_t Options = number_opts_def,
		         typename Constructor = nullable_constructor<T>>
		using json_number_null =
		  json_number<Name, T, json_details::number_opts_set<Options, JsonNullDefault>, Constructor>;
		...
		using json_checked_number_null = json_number<
		  Name,
		  T,
		  json_details::number_opts_set<Options, JsonRangeCheck::CheckForNarrowing, JsonNullDefault>,
		  Constructor>;
		...
		template<typename T = std::optional<double>,
		         json_details::json_options_t Options = number_opts_def,
		         typename Constructor = nullable_constructor<T>>
		using json_number_null_no_name = json_base::
		  json_number<T, json_details::number_opts_set<Options, JsonNullDefault>, Constructor>;
		...
		namespace json_base {
			...
			struct json_bool {
				...
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Bool;
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename Constructor = default_constructor<T>>
		using json_bool = json_named_member<Name, json_base::json_bool<T, Options, Constructor>>;
		 ...
		 */
		template<JSONNAMETYPE Name,
		         typename T = std::optional<bool>,
		         json_details::json_options_t Options = bool_opts_def,
		         typename Constructor = default_constructor<T>>
		using json_bool_null =
		  json_bool<Name, T, json_details::bool_opts_set<Options, JsonNullDefault>, Constructor>;
		...
		template<typename T = std::optional<bool>,
		         json_details::json_options_t Options = bool_opts_def,
		         typename Constructor = nullable_constructor<T>>
		using json_bool_null_no_name =
		  json_base::json_bool<T, json_details::bool_opts_set<Options, JsonNullDefault>, Constructor>;

		namespace json_base {
			/// String - A raw string as is.  Escapes are left in.
			template<typename String, json_details::json_options_t Options, typename Constructor>
			struct json_string_raw {
				...
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::String;
				...
				static constexpr AllowEscapeCharacter allow_escape_character =
				  json_details::get_bits_for<AllowEscapeCharacter>( string_raw_opts, Options );
		...
		using json_string_raw =
		  json_named_member<Name, json_base::json_string_raw<String, Options, Constructor>>;
		 ...
		 */
		template<JSONNAMETYPE Name,
		         typename String = std::optional<std::string>,
		         json_details::json_options_t Options = string_raw_opts_def,
		         typename Constructor = nullable_constructor<String>>
		using json_string_raw_null =
		  json_string_raw<Name,
		                  String,
		                  json_details::string_raw_opts_set<Options, JsonNullDefault>,
		                  Constructor>;
		...
		template<typename T = std::optional<std::string>,
		         json_details::json_options_t Options = string_raw_opts_def,
		         typename Constructor = nullable_constructor<T>>
		using json_string_raw_null_no_name = json_base::
		  json_string_raw<T, json_details::string_raw_opts_set<Options, JsonNullDefault>, Constructor>;
		...
		namespace json_base {
			...
			struct json_string {
				...
				using parse_to_t =
				  typename json_details::construction_result<nullable != JsonNullable::MustExist,
				                                             Constructor,
				                                             char const *,
				                                             char const *>::type;
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::StringEscaped;
				static constexpr EmptyStringNull empty_is_null =
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename Constructor = default_constructor<String>>
		using json_string =
		  json_named_member<Name, json_base::json_string<String, Options, Constructor>>;
		...
		template<JSONNAMETYPE Name,
		         ...
		         json_details::json_options_t Options = string_opts_def,
		         typename Constructor = nullable_constructor<String>>
		using json_string_null = json_string<Name,
		                                     String,
		...
		template<typename T = std::optional<std::string>,
		         json_details::json_options_t Options = string_opts_def,
		         typename Constructor = nullable_constructor<T>>
		using json_string_null_no_name = json_base::
		  json_string<T, json_details::string_opts_set<Options, JsonNullDefault>, Constructor>;
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename Constructor = construct_from_iso8601_timestamp<JsonNullable::MustExist>,
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_date = json_named_member<Name, json_base::json_date<T, Constructor, Nullable>>;
		...
		template<JSONNAMETYPE Name,
		         typename T = std::optional<
		           std::chrono::time_point<std::chrono::system_clock, std::chrono::milliseconds>>,
		         typename Constructor = construct_from_iso8601_timestamp<JsonNullDefault>>
		...
		namespace json_base {
			template<typename T, typename Constructor, json_details::json_options_t Options>
			struct json_class {
				using i_am_a_json_type = void;
				using wrapped_type = T;
				static constexpr bool must_be_class_member = false;
				...
				using never_constexpr = json_details::json_class_never_constexpr<base_type>;
				...
				using parse_to_t = typename std::conditional_t<
				  ...
				  daw::traits::identity<typename data_contract::template result_type<constructor_t>>>::type;

				static constexpr JsonParseTypes expected_type =
				  get_parse_type_v<JsonParseTypes::Class, nullable>;
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::Class;
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Class;
		...
		using json_class = json_named_member<Name, json_base::json_class<T, Constructor, Options>>;
		...
		using json_class_null =
		  json_class<Name, T, Constructor, json_details::class_opts_set<Options, JsonNullDefault>>;
		...
		template<typename T,
		         typename Constructor = nullable_constructor<T>,
		         json_details::json_options_t Options = class_opts_def>
		using json_class_null_no_name =
		  json_base::json_class<T, Constructor, json_details::class_opts_set<Options, JsonNullDefault>>;
		...
		struct non_discriminated_variant_base_map<json_variant_type_list<JsonElements...>> {
			static_assert( sizeof...( JsonElements ) <= 5U,
			               "There can be at most 5 items, one for each JsonBaseParseTypes" );

			static_assert( std::conjunction<json_details::has_json_deduced_type<JsonElements>...>::value,
			               "Missing specialization of daw::json::json_data_contract for class "
			               "mapping or specialization of daw::json::json_link_basic_type_map" );

			static constexpr std::size_t base_map[5] = {
			  json_details::find_json_element<JsonBaseParseTypes::Number>(
			    { json_details::json_deduced_type<JsonElements>::underlying_json_type... } ),
		...
		namespace json_base {
			template<typename Variant, typename JsonElements, typename Constructor, JsonNullable Nullable>
			struct json_variant {
				using i_am_a_json_type = void;
				static constexpr bool must_be_class_member = false;
				static constexpr JsonNullable nullable = Nullable;
				...
				static_assert( std::is_same<typename json_elements::i_am_variant_type_list, void>::value,
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::Variant;

				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::None;
		...
		using json_variant_no_name =
		  json_base::json_variant<Variant, JsonElements, Constructor, JsonNullable::MustExist>;

		template<typename Variant,
		         typename JsonElements = json_deduce_type,
		         typename Constructor = nullable_constructor<Variant>>
		using json_variant_null_no_name =
		  json_base::json_variant<Variant, JsonElements, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_tagged_variant {
				...
				using json_elements =
				  typename std::conditional_t<std::is_same<JsonElements, json_deduce_type>::value,
				...
				static_assert(
				  std::disjunction_v<json_details::is_an_ordered_member<dependent_member>,
				                     std::conjunction<json_details::is_a_json_type<dependent_member>,
				...
				using tag_member = typename std::conditional_t<
				  ...
				  daw::traits::identity<json_details::json_deduced_type<TagMember>>>::type;

				using tag_member_class_wrapper =
				  std::conditional_t<json_details::is_an_ordered_member_v<tag_member>,
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::VariantTagged;
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::None;
		...
		using json_tagged_variant = json_named_member<
		  Name,
		  json_base::json_tagged_variant<T, TagMember, Switcher, JsonElements, Constructor, Nullable>>;
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename JsonElements = json_deduce_type,
		         typename Constructor = nullable_constructor<Variant>>
		using json_tagged_variant_null = json_tagged_variant<Name,
		                                                     Variant,
		                                                     TagMember,
		                                                     Switcher,
		                                                     JsonElements,
		...
		template<typename T,
		         ...
		         typename JsonElements = json_deduce_type,
		         typename Constructor = default_constructor<T>>
		using json_tagged_variant_null_no_name = json_base::
		  json_tagged_variant<T, TagMember, Switcher, JsonElements, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_custom {
				...
				static_assert( std::is_invocable_v<ToJsonConverter, parse_to_t> or
				                 std::is_invocable_r<char *, ToJsonConverter, char *, parse_to_t>::value,
				...
				static constexpr JsonCustomTypes custom_json_type =
				  json_details::get_bits_for<JsonCustomTypes>( json_custom_opts, Options );
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename ToJsonConverter = default_to_json_converter_t<T>,
		         json_details::json_options_t Options = json_custom_opts_def>
		using json_custom_lit_null = json_custom<
		  Name,
		  T,
		  FromJsonConverter,
		  ToJsonConverter,
		  json_details::json_custom_opts_set<Options, JsonCustomTypes::Literal, JsonNullDefault>>;
		...
		namespace json_base {
			...
			struct json_array {
				...
				static_assert( traits::not_same_v<json_element_t, void>, "Unknown JsonElement type." );
				static_assert( json_details::is_a_json_type_v<json_element_t>,
				               "Error determining element type" );
				using container_t = std::conditional_t<std::is_same_v<Container, json_deduce_type>,
				                                       std::vector<json_element_parse_to_t>,
				                                       Container>;
				static constexpr JsonNullable nullable = Nullable;
				using constructor_t =
				  std::conditional_t<std::is_same_v<Constructor, json_deduce_type>,
				...
				static_assert( traits::not_same_v<void, base_type>, "Failed to detect base type" );
				...
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Array;
		...
		template<JSONNAMETYPE Name,
		         ...
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_array =
		  json_named_member<Name, json_base::json_array<JsonElement, Container, Constructor, Nullable>>;
		...
		using json_array_null_no_name =
		  json_base::json_array<JsonElement, Container, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_sized_array {
				...
				using json_element_parse_to_t = json_details::json_result<json_element_t>;
				...
				static_assert( json_details::is_nullability_compatable_v<
				                 nullable,
				                 json_details::without_name<SizeMember>::nullable>,
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::SizedArray;
		...
		template<JSONNAMETYPE Name,
		         typename JsonElement,
		         typename SizeMember,
		         typename Container = json_deduce_type,   /* std::vector<
		                 typename json_details::json_deduced_type<JsonElement>::parse_to_t>,*/
		         typename Constructor = json_deduce_type, /* default_constructor<Container>,*/
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_sized_array = json_named_member<
		  Name,
		  json_base::json_sized_array<JsonElement, SizeMember, Container, Constructor, Nullable>>;
		...
		using json_sized_array_null =
		  json_sized_array<Name, JsonElement, SizeMember, Container, Constructor, JsonNullDefault>;
		...
		using json_sized_array_null_no_name =
		  json_base::json_sized_array<JsonElement, SizeMember, Container, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_key_value {
				...
				static_assert( json_details::has_unnamed_default_type_mapping_v<JsonValueType>,
				               "Missing specialization of daw::json::json_data_contract for class "
				               "mapping or specialization of daw::json::json_link_basic_type_map" );

				using json_element_t = json_details::json_deduced_type<JsonValueType>;

				static_assert( traits::not_same_v<json_element_t, void>, "Unknown JsonValueType type." );
				static_assert( json_details::is_no_name_v<json_element_t>,
				               "Value member name must be the default no_name" );
				static_assert( json_details::has_unnamed_default_type_mapping_v<JsonKeyType>,
				               "Missing specialization of daw::json::json_data_contract for class "
				               "mapping or specialization of daw::json::json_link_basic_type_map" );

				using json_key_t = json_details::json_deduced_type<JsonKeyType>;

				static_assert( traits::not_same_v<json_key_t, void>, "Unknown JsonKeyType type." );
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::KeyValue;
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Class;
				static constexpr JsonNullable nullable = Nullable;
			};
		} // namespace json_base
		...
		using json_key_value = json_named_member<
		  Name,
		  json_base::json_key_value<Container, JsonValueType, JsonKeyType, Constructor, Nullable>>;
		...
		using json_key_value_null =
		  json_key_value<Name, Container, JsonValueType, JsonKeyType, Constructor, JsonNullDefault>;
		...
		template<typename Container,
		         ...
		         typename JsonKeyType = typename Container::key_type,
		         typename Constructor = nullable_constructor<Container>>
		using json_key_value_null_no_name = json_base::
		  json_key_value<Container, JsonValueType, JsonKeyType, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_key_value_array {
				...
				using json_key_t =
				  json_details::copy_name_when_noname<json_details::json_deduced_type<JsonKeyType>,
				...
				using json_value_t =
				  json_details::copy_name_when_noname<json_details::json_deduced_type<JsonValueType>,
				...
				using json_class_t = json_class<
				  ...
				  class_opts_def>;
				static_assert( traits::not_same_v<json_value_t, void>, "Unknown JsonValueType type." );
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::KeyValueArray;
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Array;
				static constexpr JsonNullable nullable = Nullable;
		...
		using json_key_value_array = json_named_member<
		  Name,
		  json_base::
		    json_key_value_array<Container, JsonValueType, JsonKeyType, Constructor, Nullable>>;
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename JsonKeyType = typename Container::key_type,
		         typename Constructor = nullable_constructor<Container>>
		using json_key_value_array_null = json_key_value_array<Name,
		                                                       Container,
		                                                       JsonValueType,
		                                                       JsonKeyType,
		                                                       Constructor,
		...
		using json_key_value_array_no_name =
		  json_base::json_key_value_array<Container, JsonValueType, JsonKeyType, Constructor, Nullable>;

		template<typename Container,
		         typename JsonValueType = typename Container::mapped_type,
		         typename JsonKeyType = typename Container::key_type,
		         typename Constructor = nullable_constructor<Container>>
		using json_key_value_array_null_no_name = json_base::
		  json_key_value_array<Container, JsonValueType, JsonKeyType, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_tuple {
				...
				using sub_member_list = typename std::conditional_t<
				  ...
				  daw::traits::identity<json_details::tuple_types_list<JsonTupleTypesList>>>::type::types;

				using constructor_t = std::conditional_t<
				  std::is_same<Constructor, json_deduce_type>::value,
				  std::conditional_t<
				    nullable == JsonNullable::MustExist,
				    json_details::json_class_constructor_t<base_type, default_constructor<Tuple>>,
				    json_details::json_class_constructor_t<base_type, nullable_constructor<Tuple>>>,
				  json_details::json_class_constructor_t<base_type, Constructor>>;

				static_assert( traits::not_same<void, base_type>::value, "Failed to detect base type" );

				using parse_to_t = typename json_details::
				  construction_result<nullable != JsonNullable::MustExist, constructor_t, base_type>::type;

				static constexpr JsonParseTypes expected_type =
				  get_parse_type_v<JsonParseTypes::Tuple, nullable>;
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::Tuple;
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::Array;
		...
		template<JSONNAMETYPE Name,
		         ...
		         json_details::json_options_t Options = tuple_opts_def,
		         typename JsonTupleTypesList = json_deduce_type>
		using json_tuple_null = json_tuple<Name,
		                                   Tuple,
		                                   Constructor,
		...
		template<typename Tuple,
		         ...
		         json_details::json_options_t Options = tuple_opts_def,
		         typename JsonTupleTypesList = json_deduce_type>
		using json_tuple_null_no_name =
		  json_base::json_tuple<Tuple,
		                        Constructor,
		                        json_details::tuple_opts_set<Options, JsonNullDefault>,
		                        JsonTupleTypesList>;
		...
		namespace json_base {
			...
			struct json_intrusive_variant {
				...
				static_assert( std::is_invocable_v<Switcher, json_details::json_result<tag_submember>>,
				               "There is a mismatch between the Switcher and the TagMember's parsed "
				               "result" );

				using switcher = Switcher;

				using tag_submember_class_wrapper =
				  std::conditional_t<json_details::is_an_ordered_member<tag_submember>::value,
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::VariantIntrusive;
				static constexpr JsonBaseParseTypes underlying_json_type = JsonBaseParseTypes::None;

				using json_container_type = std::conditional_t<
				  std::disjunction_v<
				    json_details::is_an_ordered_member<json_details::json_deduced_type<tag_submember>>,
				    json_details::is_no_name<json_details::json_deduced_type<tag_submember>>>,
				  json_tuple<
				    std::tuple<typename json_details::json_deduced_type<tag_submember>::parse_to_t>,
				    default_constructor<
				      std::tuple<typename json_details::json_deduced_type<tag_submember>::parse_to_t>>,
				    tuple_opts_def,
				    json_tuple_types_list<tag_submember>>,
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename Constructor = default_constructor<Variant>,
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_intrusive_variant = json_named_member<
		  Name,
		  json_base::
		    json_intrusive_variant<Variant, TagMember, Switcher, JsonElements, Constructor, Nullable>>;
		...
		template<JSONNAMETYPE Name,
		         ...
		         typename Switcher,
		         typename JsonElements =
		           json_details::determine_variant_element_types<JsonNullable::MustExist, Variant>,
		         typename Constructor = default_constructor<Variant>>
		using json_intrusive_variant_null = json_intrusive_variant<Name,
		                                                           Variant,
		                                                           TagMember,
		                                                           Switcher,
		                                                           JsonElements,
		...
		template<typename T,
		         ...
		         typename Constructor = default_constructor<T>,
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_intrusive_variant_no_name = json_base::
		  json_intrusive_variant<T, TagMember, Switcher, JsonElements, Constructor, Nullable>;
		...
		template<typename T,
		         ...
		         typename JsonElements =
		           json_details::determine_variant_element_types<JsonNullable::MustExist, T>,
		         typename Constructor = default_constructor<T>>
		using json_intrusive_variant_null_no_name = json_base::
		  json_intrusive_variant<T, TagMember, Switcher, JsonElements, Constructor, JsonNullDefault>;
		...
		namespace json_base {
			...
			struct json_raw {
				...
				static constexpr JsonParseTypes base_expected_type = JsonParseTypes::Unknown;
		 ...
		 */
		template<JSONNAMETYPE Name,
		         typename T = json_value,
		         typename Constructor = default_constructor<T>,
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_raw = json_named_member<Name, json_base::json_raw<T, Constructor, Nullable>>;

		template<JSONNAMETYPE Name,
		         typename T = json_value,
		         typename Constructor = default_constructor<T>,
		         JsonNullable Nullable = JsonNullable::MustExist>
		using json_delayed [[deprecated( "Was renamed to json_raw, will be removed in v4" )]] =
		...
		struct json_data_contract<basic_json_value<ParseState>> {
			using type = json_class_map<json_raw_no_name<basic_json_value<ParseState>>>;
		};
		...
		*/
		...
		using json_link =
		  json_named_member<Name,
		                    typename json_details::ensure_mapped_t<json_details::json_deduced_type<T>>>;
