...
md build
cd build
"C:/PROGRAM FILES (X86)/MICROSOFT VISUAL STUDIO/%1/ENTERPRISE/COMMON7/IDE/COMMONEXTENSIONS/MICROSOFT/CMAKE/CMake/bin/cmake.exe" -DCMAKE_BUILD_TYPE=%3 -GNinja -DCMAKE_CXX_COMPILER="C:/Program Files (x86)/Microsoft Visual Studio/%1/Enterprise/VC/Tools/Llvm/x64/bin/clang-cl.exe" -DCMAKE_C_COMPILER="C:/Program Files (x86)/Microsoft Visual Studio/%1/Enterprise/VC/Tools/Llvm/x64/bin/clang-cl.exe" -DCMAKE_PREFIX_PATH="c:/testing" ..
...
IF %ERRORLEVEL% NEQ 0 EXIT %ERRORLEVEL%
"C:/PROGRAM FILES (X86)/MICROSOFT VISUAL STUDIO/%1/ENTERPRISE/COMMON7/IDE/COMMONEXTENSIONS/MICROSOFT/CMAKE/CMake/bin/ctest.exe" -C %2 -VV 
IF %ERRORLEVEL% NEQ 0 EXIT %ERRORLEVEL%
