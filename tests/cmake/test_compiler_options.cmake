...
if( ${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang" OR ${CMAKE_CXX_COMPILER_ID} STREQUAL "AppleClang" )
	if( MSVC )
		...
		if( CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 19 )
			set( CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -DDEBUG /permissive- /EHsc -D_LIBCPP_HARDENING_MODE=4" )
		else()
		...
		if( ${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang"
			...
			if( CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 19 )
				set( CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g -DDEBUG -D_LIBCPP_HARDENING_MODE=4 -D_GLIBCXX_ASSERTIONS -D_GLIBCXX_CONCEPT_CHECKS -D_FORTIFY_SOURCE=2" )
			else()
			...
			if( CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 19 )
				set( CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -g -DDEBUG -D_LIBCPP_HARDENING_MODE=4" )
			else()
