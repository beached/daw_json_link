...
namespace {
	...
	namespace symbols_metadata_t {
		inline constexpr char const result_type[] = "result_type";
	...
	to_json_data( metadata_t const &value ) {
	...
	namespace symbols_urls_element_t {
		...
		inline constexpr char const expanded_url[] = "expanded_url";
		inline constexpr char const display_url[] = "display_url";
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( urls_element_t const &value ) {
	...
	[[nodiscard, maybe_unused]] inline auto to_json_data( url_t const &value ) {
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( description_t const &value ) {
		return std::forward_as_tuple( value.urls );
	}
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( entities_t const &value ) {
	...
	namespace symbols_user_t {
		inline constexpr char const id[] = "id";
		inline constexpr char const id_str[] = "id_str";
		inline constexpr char const name[] = "name";
		inline constexpr char const screen_name[] = "screen_name";
		inline constexpr char const location[] = "location";
		inline constexpr char const description[] = "description";
		inline constexpr char const url[] = "url";
		inline constexpr char const entities[] = "entities";
		inline constexpr char const _jsonprotected[] = "protected";
		inline constexpr char const followers_count[] = "followers_count";
		inline constexpr char const friends_count[] = "friends_count";
		inline constexpr char const listed_count[] = "listed_count";
		inline constexpr char const created_at[] = "created_at";
		inline constexpr char const favourites_count[] = "favourites_count";
		inline constexpr char const utc_offset[] = "utc_offset";
		inline constexpr char const time_zone[] = "time_zone";
		inline constexpr char const geo_enabled[] = "geo_enabled";
		inline constexpr char const verified[] = "verified";
		inline constexpr char const statuses_count[] = "statuses_count";
		inline constexpr char const lang[] = "lang";
		inline constexpr char const contributors_enabled[] = "contributors_enabled";
		inline constexpr char const is_translator[] = "is_translator";
		inline constexpr char const is_translation_enabled[] =
		  "is_translation_enabled";
		inline constexpr char const profile_background_color[] =
		  "profile_background_color";
		inline constexpr char const profile_background_image_url[] =
		  "profile_background_image_url";
		inline constexpr char const profile_background_image_url_https[] =
		  "profile_background_image_url_https";
		inline constexpr char const profile_background_tile[] =
		  "profile_background_tile";
		inline constexpr char const profile_image_url[] = "profile_image_url";
		inline constexpr char const profile_image_url_https[] =
		  "profile_image_url_https";
		inline constexpr char const profile_banner_url[] = "profile_banner_url";
		inline constexpr char const profile_link_color[] = "profile_link_color";
		inline constexpr char const profile_sidebar_border_color[] =
		  "profile_sidebar_border_color";
		inline constexpr char const profile_sidebar_fill_color[] =
		  "profile_sidebar_fill_color";
		inline constexpr char const profile_text_color[] = "profile_text_color";
		inline constexpr char const profile_use_background_image[] =
		  "profile_use_background_image";
		inline constexpr char const default_profile[] = "default_profile";
		inline constexpr char const default_profile_image[] =
		  "default_profile_image";
		inline constexpr char const following[] = "following";
		inline constexpr char const follow_request_sent[] = "follow_request_sent";
	...
	[[nodiscard, maybe_unused]] inline auto json_data_contract_for( user_t ) {
		...
		return daw::json::json_data_contract<
		  ...
		  json_bool<symbols_user_t::geo_enabled>,
		  json_bool<symbols_user_t::verified>,
	...
	[[nodiscard, maybe_unused]] inline auto to_json_data( user_t const &value ) {
		return std::forward_as_tuple(
		  ...
		  value.time_zone, value.geo_enabled, value.verified, value.statuses_count,
		  value.lang, value.contributors_enabled, value.is_translator,
	...
	namespace symbols_hashtags_element_t {
		inline constexpr char const text[] = "text";
		inline constexpr char const indices[] = "indices";
	} // namespace symbols_hashtags_element_t
...
#endif
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( hashtags_element_t const &value ) {
	...
	json_data_contract_for( statuses_element_t ) {
		...
		return daw::json::json_data_contract<
		  ...
		  json_class<"entities", entities_t>, json_bool<"favorited">,
		  json_bool<"retweeted">, json_bool_null<"possibly_sensitive">,
		  json_string<"lang">>{};
	}
#else
	namespace symbols_statuses_element_t {
		inline constexpr char const metadata[] = "metadata";
		inline constexpr char const created_at[] = "created_at";
		inline constexpr char const id[] = "id";
		inline constexpr char const id_str[] = "id_str";
		inline constexpr char const text[] = "text";
		inline constexpr char const source[] = "source";
		inline constexpr char const truncated[] = "truncated";
		inline constexpr char const in_reply_to_status_id[] =
		  "in_reply_to_status_id";
		inline constexpr char const in_reply_to_status_id_str[] =
		  "in_reply_to_status_id_str";
		inline constexpr char const in_reply_to_user_id[] = "in_reply_to_user_id";
		inline constexpr char const in_reply_to_user_id_str[] =
		  "in_reply_to_user_id_str";
		inline constexpr char const in_reply_to_screen_name[] =
		  "in_reply_to_screen_name";
		inline constexpr char const user[] = "user";
		inline constexpr char const retweet_count[] = "retweet_count";
		inline constexpr char const favorite_count[] = "favorite_count";
		inline constexpr char const entities[] = "entities";
		inline constexpr char const favorited[] = "favorited";
		inline constexpr char const retweeted[] = "retweeted";
		inline constexpr char const possibly_sensitive[] = "possibly_sensitive";
		inline constexpr char const lang[] = "lang";
	} // namespace symbols_statuses_element_t
...
#endif
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( statuses_element_t const &value ) {
		return std::forward_as_tuple(
		  ...
		  value.retweet_count, value.favorite_count, value.entities,
		  value.favorited, value.retweeted, value.possibly_sensitive, value.lang );
	}
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( user_mentions_element_t const &value ) {
	...
	namespace symbols_medium_t {
		inline constexpr char const w[] = "w";
		inline constexpr char const h[] = "h";
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( medium_t const &value ) {
	...
	[[nodiscard, maybe_unused]] inline auto to_json_data( small_t const &value ) {
		return std::forward_as_tuple( value.w, value.h, value.resize );
	}
	...
	[[nodiscard, maybe_unused]] inline auto to_json_data( thumb_t const &value ) {
		return std::forward_as_tuple( value.w, value.h, value.resize );
	}
	...
	[[nodiscard, maybe_unused]] inline auto to_json_data( large_t const &value ) {
		return std::forward_as_tuple( value.w, value.h, value.resize );
	}
	...
	namespace symbols_sizes_t {
		inline constexpr char const medium[] = "medium";
		inline constexpr char const small_[] = "small";
		inline constexpr char const thumb[] = "thumb";
	...
	[[nodiscard, maybe_unused]] inline auto to_json_data( sizes_t const &value ) {
	...
	namespace symbols_media_element_t {
		...
		inline constexpr char const id_str[] = "id_str";
		inline constexpr char const indices[] = "indices";
		inline constexpr char const media_url[] = "media_url";
		inline constexpr char const media_url_https[] = "media_url_https";
		inline constexpr char const url[] = "url";
		inline constexpr char const display_url[] = "display_url";
		inline constexpr char const expanded_url[] = "expanded_url";
		inline constexpr char const type[] = "type";
		inline constexpr char const sizes[] = "sizes";
	} // namespace symbols_media_element_t
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( media_element_t const &value ) {
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( retweeted_status_t const &value ) {
		return std::forward_as_tuple(
		  value.metadata, value.created_at, value.id, value.id_str, value.text,
		  value.source, value.truncated, value.in_reply_to_status_id,
		  value.in_reply_to_status_id_str, value.in_reply_to_user_id,
	...
	namespace symbols_search_metadata_t {
		inline constexpr char const completed_in[] = "completed_in";
		inline constexpr char const max_id[] = "max_id";
		inline constexpr char const max_id_str[] = "max_id_str";
		inline constexpr char const next_results[] = "next_results";
		inline constexpr char const query[] = "query";
		inline constexpr char const refresh_url[] = "refresh_url";
		inline constexpr char const count[] = "count";
		inline constexpr char const since_id[] = "since_id";
		inline constexpr char const since_id_str[] = "since_id_str";
	} // namespace symbols_search_metadata_t
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( search_metadata_t const &value ) {
	...
	namespace symbols_twitter_object_t {
		inline constexpr char const statuses[] = "statuses";
		inline constexpr char const search_metadata[] = "search_metadata";
	} // namespace symbols_twitter_object_t
	...
	[[nodiscard, maybe_unused]] inline auto
	to_json_data( twitter_object_t const &value ) {
