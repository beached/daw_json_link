	...
	struct json_data_contract<daw::bench::bench_result> {
		...
		using type =
		  json_member_list<json_string<name>,
		                   ...
		                   json_nanosecond<duration_min>,
		                   json_nanosecond<duration_25th_percentile>,
		                   json_nanosecond<duration_50th_percentile>,
		                   json_nanosecond<duration_75th_percentile>,
		                   json_nanosecond<duration_max>,
		                   json_string<git_revision>,
		                   json_string<processor_description>,
		                   json_string<os_name>,
		                   json_string<os_release>,
		                   json_string<os_version>,
		                   json_string<os_platform>,
		                   json_string<build_type>,
		                   json_string<project_name>,
		                   json_string<project_subname>>;
