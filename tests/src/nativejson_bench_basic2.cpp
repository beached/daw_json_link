...
#endif
{
	...
	daw::bench_n_test_mbs<DAW_NUM_RUNS>(
	  ...
	  [&]( auto f1, auto f2, auto f3 ) {
		  ...
		  j2 =
		    daw::json::from_json<daw::citm::citm_object_t, daw::json::NoCommentSkippingPolicyUnchecked>(
		      f2 );
		  j3 = daw::json::from_json<daw::geojson::Polygon, daw::json::NoCommentSkippingPolicyUnchecked>(
		    f3,
		    "features[0].geometry" );
	...
	for( size_t n = 0; n < DAW_NUM_RUNS; ++n ) {
		j1 = daw::json::from_json<daw::twitter2::twitter_object_t,
		                          daw::json::NoCommentSkippingPolicyUnchecked>( sv_twitter );
		j2 =
		  daw::json::from_json<daw::citm::citm_object_t, daw::json::NoCommentSkippingPolicyUnchecked>(
		    sv_citm );
		j3 = daw::json::from_json<daw::geojson::Polygon, daw::json::NoCommentSkippingPolicyUnchecked>(
