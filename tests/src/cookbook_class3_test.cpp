...
namespace daw::json {
	...
	struct json_data_contract<daw::cookbook_class3::MyClass1> {
		...
		using type =
		  json_member_list<json_string<member0>, json_number<member1, int>, json_bool<member2>>;
#endif
		static inline auto to_json_data( daw::cookbook_class3::MyClass1 const &value ) {
...
#if defined( __cpp_nontype_template_parameter_class )
		using type = json_member_list<json_class<"a", daw::cookbook_class3::MyClass1>>;
#else
		static constexpr char const a[] = "a";
		using type = json_member_list<json_class<a, daw::cookbook_class3::MyClass1>>;

#endif
		static inline auto to_json_data( daw::cookbook_class3::MyClass3 const &value ) {
