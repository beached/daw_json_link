...
void display_exception( daw::json::basic_json_exception<true> const &jex,
                        char const *json_data ) {
	display_exception_impl( jex, json_data );
}
#else
void display_exception( daw::json::basic_json_exception<false> const &jex,
                        char const *json_data ) {
	display_exception_impl( jex, json_data );
}
#endif
