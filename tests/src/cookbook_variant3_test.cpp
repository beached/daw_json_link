...
struct daw::json::json_data_contract<daw::cookbook_variant3::MyClass> {
	...
	using type = json_member_list<
	  ...
	  json_tagged_variant<
	    ...
	    json_variant_type_list<std::string, json_number_no_name<int>, json_bool_no_name<>>>>;
#else
	...
	using type = json_member_list<
	  ...
	  json_tagged_variant<
	    ...
	    json_variant_type_list<std::string, json_number_no_name<int>, json_bool_no_name<>>>>;
#endif
	static DAW_CONSTEXPR inline auto to_json_data( daw::cookbook_variant3::MyClass const &v ) {
