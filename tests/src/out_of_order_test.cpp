...
namespace daw::json {
	...
	struct json_data_contract<Foo> {
		...
		using type =
		  json_member_list<json_number<a, double, LiteralAsStringOpt::Always>,
		                   json_number<b, double, LiteralAsStringOpt::Always>,
		                   json_bool<c, bool, LiteralAsStringOpt::Always>,
		                   json_bool<d, bool, LiteralAsStringOpt::Always>,
		                   json_number<e, int, LiteralAsStringOpt::Always>,
		                   json_number<f, int, LiteralAsStringOpt::Always>,
		                   json_number<g, unsigned, LiteralAsStringOpt::Always>,
		                   json_number<h, unsigned, LiteralAsStringOpt::Always>>;
