...
#endif
{
	...
	puts( "Original" );
	puts( data.c_str( ) );
	auto stuff = daw::json::from_json<std::vector<daw::cookbook_variant1::MyVariantStuff1>>( data );
	...
	test_assert( ( std::get<0>( stuff.front( ).member1.value( ) ) == "hello" ), "Unexpected value" );
