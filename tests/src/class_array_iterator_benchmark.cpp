...
namespace {
	...
	using point_json = json_class_no_name<point_t>;
	using scalar_iterator = json_array_iterator<point_json>;
	using simd_iterator = json_simd_block_iterator<point_json, char>;
