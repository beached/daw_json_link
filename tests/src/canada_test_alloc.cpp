...
#endif
{
	...
	auto const canada_result =
	  daw::json::from_json_alloc<daw::geojson::Polygon>( json_sv1, "features[0].geometry", alloc );
	std::string str{ };
	{
	...
	daw::do_not_optimize( str );
	auto const canada_result2 = daw::json::from_json_alloc<daw::geojson::Polygon>( str, alloc );
