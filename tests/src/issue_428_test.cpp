...
struct vector_map {
   ...
   public:
    ...
    template <typename Container>
        requires(!std::is_same_v<vector_map, std::remove_cvref_t<Container>>)
...
struct map_builder {
    constexpr class_type operator()() const { return class_type{}; }
    constexpr class_type operator()(auto &&v) const { return class_type(v); }
