...
namespace daw::cookbook_variant4 {
	...
	using configs_t = std::variant<daw::cookbook_variant4::ConfigV1,
	                               daw::cookbook_variant4::ConfigV2>;
...
namespace daw::json {
	template<>
	struct json_data_contract<daw::cookbook_variant4::ConfigV1> {
		...
		to_json_data( daw::cookbook_variant4::ConfigV1 const &v ) {
	...
	template<>
	struct json_data_contract<daw::cookbook_variant4::ConfigV2> {
		static constexpr char const mem_version[] = "version";
		...
		static constexpr auto
		to_json_data( daw::cookbook_variant4::ConfigV2 const &v ) {
	...
	struct json_data_contract<daw::cookbook_variant4::configs_t> {
		...
		using type = json_submember_tagged_variant<
		  ...
		  daw::cookbook_variant4::ConfigV1, daw::cookbook_variant4::ConfigV2>;
	};
} // namespace daw::json
