...
namespace daw::cookbook_variant4 {
	...
	using configs_t =
	  std::variant<daw::cookbook_variant4::v1::Config, daw::cookbook_variant4::v2::Config>;
...
#endif
{
	...
	auto configs = daw::json::from_json_array<daw::cookbook_variant4::configs_t>( json_data );
